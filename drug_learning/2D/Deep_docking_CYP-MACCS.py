...
features_shared = np.load(os.path.join("features", f"shared_set_features_{FINGERPRINT}.npy"))
features_only_2c9 = np.load(os.path.join("features", f"only_2c9_set_features_{FINGERPRINT}.npy"))
features_only_3a4 = np.load(os.path.join("features", f"only_3a4_set_features_{FINGERPRINT}.npy"))
